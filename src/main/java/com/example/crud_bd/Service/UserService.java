...
public class UserService {
    ...
    public List<User> getAllUsers() {
        return Optional.ofNullable(userRepository.findAll()).orElseThrow(() -> new UserNotFoundException("Users not found",HttpStatus.NOT_FOUND));
    }

    public List<User> getAllAdultUser() {
        return Optional.ofNullable(userRepository.findAllAdultUsers()).orElseThrow(() -> new UserNotFoundException("Users not found",HttpStatus.NOT_FOUND));
    }
    ...
    public User createUser(User user) {
        ...
        return Optional.of(userRepository.save(user)).orElseThrow(() -> new UserNotFoundException("User not found",HttpStatus.BAD_REQUEST));
    }
